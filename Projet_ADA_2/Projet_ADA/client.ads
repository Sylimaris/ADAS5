...
Package client is
	...
	Procedure saisie_note(Planning : IN OUT T_planning; date_du_jour : IN sjour; cuisto : IN integer);
	
	Procedure passage_au_lendemain(date_du_jour : IN OUT sjour; Tableau_Cuisinier : IN OUT T_club; Planning : IN OUT T_planning);
